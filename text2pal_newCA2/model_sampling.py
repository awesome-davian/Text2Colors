...
class Attn(nn.Module):
    def __init__(self, hidden_size, max_length):
        ...
        # self.other = nn.Parameter(torch.ones(batch_size, hidden_size, 1).float())
        # self.other = nn.Parameter(torch.rand(self.hidden_size, 1).normal_()) # [-1,1]
